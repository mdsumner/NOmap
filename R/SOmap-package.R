...
#' @importFrom ggplot2 aes_string coord_sf element_blank fortify ggplot geom_path geom_polygon geom_raster geom_sf geom_text labs scale_fill_gradientn theme
